        ...
        <div id="home" class="tab-pane fade in active">
            <form class="form-horizontal" role="form">
                ...
                <div class="form-group ">
                    ...
                    <div class="col-xs-4">
                        <input class="form-control  " readonly="readonly" id="" value="团长职务" type="text"   />
                    </div>
                </div> <div class="form-group ">
                    <label class="col-xs-2 control-label "  > 团长专业: </label>
                    <div class="col-xs-4">
                        <input class="form-control  " readonly="readonly" id="" value="团长专业" type="text"   />
                    </div>
                ...
                <div class="col-md-offset-3 col-md-9">
                    <button class="btn btn-info btn-sm"  id="colse" type="button">
