...
<script type="text/javascript">
            ...
            colModel:[
                ...
                {name:'id',index:'', fixed:true, sortable:false, resize:true,
                    formatter:function(cellvalue, options, rowObject){
                        var zt = rowObject.zt;
                        if(zt == '通过' ){
                            return "<button class='btn btn-danger btn-mini' onclick='uploadZj("+cellvalue+")' title='测试' ><i class='ace-icon fa fa-spinner  '>上传总结</i></button>";
                        }else{
                            return "";
                        }
                    }
    ...
    //上传外宾接待总结
    function uploadZj(jdid){
        layer.newpage({
            area: ['600px','200px'],
            title:'上传总结文档',
            content:'business/wblfgl/wbgl_zj_upload.jsp',
        });
    }
