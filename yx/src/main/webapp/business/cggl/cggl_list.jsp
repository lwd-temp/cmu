            ...
            colModel:[
                ...
                {name:'id',index:'', fixed:true, sortable:false, resize:true,
                    formatter:function(cellvalue, options, rowObject){
                        var zt = rowObject.zt;
                        if(zt == '暂存'){
                            return  "<button class='btn btn-info btn-mini' title='测试' onclick='editCgsq(\"+cellvalue+\")' ><i class='ace-icon fa fa-pencil '>编辑</i></button>";
                        }else{
                            return  "<button class='btn btn-warning btn-mini' title='查看' onclick='editCgsq(\"+cellvalue+\")' ><i class='ace-icon fa fa-eye '>查看</i></button>";
                        }
                    }
                },
            ]
