...
public class HzServiceImpl extends BaseService<Hz, HzParams, HzMapper> implements HzService {
    ...
    public void halfYearRemind() {
        ...
        String description = ResourceBundleUtils.getString("ifs.wechat.hz.bntx.title");//国际事务部通知
        String content = ResourceBundleUtils.getString("ifs.wechat.hz.bntx.title");//尊敬的老师您好，您的护照还有半年即将超期，请知晓中文
