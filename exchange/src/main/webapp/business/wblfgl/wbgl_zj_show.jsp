        ...
        <div class="tab-content">
            <div id="home" class="tab-pane fade in active">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-4">
                        <dm:list tabName="t_dm_lfmd"  name="wbjdZj.lfmd" id="lfmd" disabled="disabled" data-placeholder="请选择来访目的" value="${wbjdZj.lfmd}"  onchange="selectlfmd(this)"></dm:list>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control  " name="wbjdZj.jfly" disabled="disabled" value="${wbjdZj.jfly}" type="text"   />
                    </div>
                </div>
                <div class="form-group">
