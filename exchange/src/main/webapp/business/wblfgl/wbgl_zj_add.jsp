    ...
    <div class="tabbable">
        <div class="tab-content">
            <div id="home" class="tab-pane fade in active">
                <input type="hidden"    name="wbjdZj.lfid" value="${wbjdSq.lfid}"/>
                <input type="hidden"   id="status"  name="wbjdZj.status" value="${wbjdSq.status}"/>
                ...
                <div class="form-group ">
                    ...
                    <div class="col-xs-12 col-sm-4">
                        <dm:list tabName="t_dm_wblf_jdlx"  id="jdlx" name="wbjdZj.jdlx" value="${wbjdSq.jdlx}" data-placeholder="请选接待类型" ></dm:list>
                    </div>
                    <label class="col-xs-12 col-sm-2 control-label "  > 接待部门: </label>
                    <div class="col-xs-12 col-sm-4">
                        <input class="form-control" id="jdbm" name="wbjdZj.jdbm" value="${wbjdSq.jdbm}" type="text"   />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-2 control-label "  > 代表团名称: </label>
                    <div class="col-xs-12 col-sm-4">
                        <input type="text"  name="wbjdZj.dbtmc"   placeholder="" value="${wbjdSq.dbtmc}" class="col-xs-12" />
                    </div>
                    <label class="col-xs-12 col-sm-2 control-label " > 来访人数: </label>
                    <div class="col-xs-12 col-sm-4">
                        <input type="text"  name="wbjdZj.lfrs" id="lfrs"   placeholder="" value="${wbjdSq.lfrs}" class="col-xs-12" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-4">
                        <dm:list tabName="t_dm_lfmd" type="select"  multiple="multiple" name="wbjdZj.lfmd" id="lfmd" data-placeholder="请选择来访目的" value="${wbjdSq.lfmd}"  onchange="selectlfmd(this)"></dm:list>
                    </div>
                ...
                <div class="form-group qtmd">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control  " name="wbjdZj.lfmdQt" value="${wbjdSq.lfmdQt}" type="text"   />
                    </div>
                </div>
                <div class="form-group yjtm" >
                    <label class="col-xs-12 col-sm-2 control-label "  > 演讲题目: </label>
                    <div class="col-xs-10">
                        <input class="form-control  " name="wbjdZj.yjtm" value="${wbjdSq.yjtm}" type="text"   />
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-xs-10">
                        <textarea class="form-control limited" name="wbjdZj.jfly"  placeholder="请输入经费来源"  maxlength="300">${wbjdSq.jfly}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-4">
                        <dm:list tabName="t_dm_yn"  name="wbjdZj.ynYqxld" type="radio" id="ynYqxld"
                                 value="${wbjdSq.ynYqxld}"  onclick="getRadio(this)" data-placeholder="请选是否邀请校领导" ></dm:list>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-4">
                        <dm:list tabName="t_dm_yn"  name="wbjdZj.ynXyty"  type="radio" id="ynXyty"
                                 value="${wbjdSq.ynXyty}" onclick="getRadio(this)" data-placeholder="请选是否获学院同意" ></dm:list>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-4">
                        <dm:list tabName="t_dm_yn"  name="wbjdZj.ynBbssgabm"   type="radio" id="ynBbssgabm"
                                 value="${wbjdSq.ynBbssgabm}"  onclick="getRadio(this)" data-placeholder="请选是否报备属地公安部门" ></dm:list>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-4">
                        <dm:list tabName="t_dm_yn"  name="wbjdZj.ynBbssxcbm"   type="radio" id="ynBbssxcbm"
                                 value="${wbjdSq.ynBbssxcbm}" onclick="getRadio(this)" data-placeholder="请选是否报备学校宣传部" ></dm:list>
                    </div>
                </div>
                <div class="form-group "  >
            ...
            <div class="form-group ">
                ...
                <div class="col-xs-10">
                    <textarea class="form-control limited" name="wbjdZj.qkjl"  placeholder="情况记录"  maxlength="300">${wbjdSq.qkjl}</textarea>
                </div>
            </div>
            ...
            <div class="form-group ">
                ...
                <div class="col-xs-12 col-sm-4">
                    <input class="form-control  " name="wbjdZj.tzxm" value="${wbjdSq.tzxm}"  type="text"   />
                </div>
                <label class="col-xs-12 col-sm-2 control-label "  > 团长国籍: </label>
                <div class="col-xs-12 col-sm-4">
                    <input class="form-control  " name="wbjdZj.tzgj" value="${wbjdSq.tzgj}"  type="text"   />
            ...
            <div class="form-group ">
                ...
                <div class="col-xs-12 col-sm-4">
                    <dm:list tabName="t_dm_xb"  name="wbjdZj.tzxb" type="radio" value="${wbjdSq.tzxb}" data-placeholder="请选接团长性别" ></dm:list>
                </div>
            ...
            <div class="form-group ">
                ...
                <div class="col-xs-12 col-sm-4">
                    <input class="form-control  " name="wbjdZj.tzgzdw" value="${wbjdSq.tzgzdw}" type="text"   />
                </div>

                <label class="col-xs-12 col-sm-2 control-label "  > 团长职称: </label>
                <div class="col-xs-12 col-sm-4">
                    <input class="form-control  " name="wbjdZj.tzzc" value="${wbjdSq.tzzc}" type="text"   />
                </div>
            </div>
            <div class="form-group ">
                <label class="col-xs-12 col-sm-2 control-label "  > 专业及学术领域: </label>
                <div class="col-xs-12 col-sm-4">
                    <input class="form-control  " name="wbjdZj.tzzy" value="${wbjdSq.tzzy}" type="text"   />
                </div>
                <label class="col-xs-12 col-sm-2 control-label "  > 团长职务: </label>
                <div class="col-xs-12 col-sm-4">
                    <input class="form-control  " name="wbjdZj.tzzw" value="${wbjdSq.tzzw}" type="text"   />
                </div>
            </div>
            <div class="form-group ">
                <label class="col-xs-12 col-sm-2 control-label "  > 主请联系人姓名: </label>
                <div class="col-xs-12 col-sm-4">
                    <input class="form-control  " id="zqlxrxm" name="wbjdZj.zqlxrxm" value="${wbjdSq.zqlxrxm}" type="text"   />
                </div>

                <label class="col-xs-12 col-sm-2 control-label "  > 主请联系人电话: </label>
                <div class="col-xs-12 col-sm-4">
                    <input class="form-control  " id="zqlxrdh" name="wbjdZj.zqlxrdh" value="${wbjdSq.zqlxrdh}" type="text"   />
                </div>
            </div>
            <div class="form-group ">
                <label class="col-xs-12 col-sm-2 control-label "  > 访问成果: </label>
                <div class="col-xs-10">
                    <input class="form-control " id="fwcg" name="wbjdZj.fwcg" value="${wbjdSq.fwcg}" style="color:red;background-color: #47ca8d" type="text"   />
                </div>
            </div>
                        ...
                        <div class="widget-body">
                            ...
                            <c:if test="${lpList!=null && lpList.size()>0}">
                                <c:forEach items="${lpList}" var="lp">
                                    <div class="form-group sxr">
                                        <div class="col-xs-5"><input type="text" inp="mc" placeholder="姓名"   value="${lp.mc}"   name="lp[@].mc" class="col-xs-12"/></div>
                                        <div class="col-xs-12 col-sm-4"><input type="text" inp="sl"  placeholder="国籍"  value="${lp.sl}"   name="lp[@].sl" class="col-xs-12"/></div>
                                        <div class="col-xs-3">
...
<script>
    $(function () {
        ...
        $('input[name="wbjdZj.ynYqxld"][value="Y"]').click(function(){
            ...
            $("#memo").val("校领导： "+$("#memo1").val());
        });

        //是否邀请校领导， 选否，提示在备注中输入之前内容
        $('input[name="wbjdZj.ynYqxld"][value="N"]').click(function(){
            $("#memo").val($("#memo1").val());
        });
