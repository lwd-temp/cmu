        ...
        <div id="home" class="tab-pane fade in active">
            <form class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-4">
                        <input class="form-control date-picker" id="" value="2018-09-15" type="text" data-date-format="yyyy-mm-dd" />
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-4">
                        <select class="chosen-select form-control"   data-placeholder="请选择国家"  multiple="multiple" >
                    ...
                    <div class="col-xs-4">
                        <select class="chosen-select form-control"   data-placeholder="请选择来访目的"   onchange="changeMuDi(this)">
                            <option value="01">友好访问</option>
                ...
                <div class="form-group ">
                    ...
                    <div class="col-xs-4">
                        <select class="chosen-select form-control"   data-placeholder="请选择接待部门"    >
                    ...
                    <div class="col-xs-4">
                        <select class="chosen-select form-control"   data-placeholder="请选接待类型"    >
                            <option value="01">校级接待</option>
                            <option value="02">院级接待</option>
                        </select>
                    </div>
                </div>
