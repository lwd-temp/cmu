        ...
        <div class="tab-content">
            <div id="home" class="tab-pane fade in active">
                ...
                <%--<div class="form-group">--%>
                    ...
                    <%--<div class="col-xs-12 col-sm-4">--%>
                        <%--<input class="form-control date-picker" name="cgTzjh.rwpfsj" id="rwpfsj" value="<fmt:formatDate value="${cgTzjh.rwpfsj}" pattern="yyyy-MM-dd"/>" type="text" data-date-format="yyyy-mm-dd" placeholder="请输入任务批复时间"/>--%>
                    <%--</div>--%>
                <%--</div>--%>
                ...
                <c:choose>
                    <c:when test="${cyList!=null && cyList.size()>0}">
                        <c:forEach items="${cyList}" var="cy">
                            <div class="form-group cy">
                                <div class="col-xs-12 col-sm-2"><input type="text" value="${cy.xm}" inp="xm"   placeholder="姓名"  name="cys[@].xm"  class="col-xs-12"/></div>
                                <div class="col-xs-3">
                                ...
                                <div class="col-xs-12 col-sm-2"><input type="text" value="${cy.jb}" inp="jb"          placeholder="姓名"   name="cys[@].jb" class="col-xs-12"/></div>
                                <div class="col-xs-12 col-sm-2">
                    ...
                    <c:otherwise>
                        <div class="form-group cy">
                            ...
                            <div class="col-xs-12 col-sm-2"><input type="text" inp="jb"     placeholder="姓名"    name="cys[@].jb" class="col-xs-12"/></div>
                            <div class="col-xs-12 col-sm-2">
                                <button class='btn btn-danger btn-mini' onclick='deleteCy(this);return false;'><i class='ace-icon fa fa-trash-o  '>删除</i></button>
                                <button class='btn btn-info btn-mini' onclick='appendCy(); return false;'><i class='ace-icon fa fa-plus '>添加</i>  </button>
                            </div>
