                    ...
                    <div class="col-xs-12">
                        <form class="form-horizontal" id="form" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <input type="text"  name="xm" id="xm" value="${hz.xm}"  class="col-xs-12" />
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <input type="text"  name="csdd"  value="${hz.gj}"    class="col-xs-12" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <input type="text"  name="qfdd"  value="${hz.gj}"    class="col-xs-12" />
                                </div>
                            </div>
                            <div class="form-group">
