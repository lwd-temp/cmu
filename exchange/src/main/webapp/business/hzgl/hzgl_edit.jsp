                    ...
                    <div class="col-xs-12">
                        <form class="form-horizontal" id="form" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <input class="form-control date-picker" id="id-date-picker-1" value="${hz.birthday}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <input class="form-control date-picker"   value="${hz.qfrq}" name="qfrq"
                                           type="text" date-format="yyyy-mm-dd" />
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <input class="form-control date-picker"   value="${hz.yxqz}" name="qfrq"
                                           type="text" date-format="yyyy-mm-dd" />
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <input class="form-control date-picker"   value="${hz.jcsj}" name="qfrq"
                                           type="text" date-format="yyyy-mm-dd" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-xs-2 control-label "  > 证件类型   : </label>
                                <dm:list tabName="t_dm_tzlb" type="select"   name="hzlx"  value="${hz.hzlx}" ></dm:list>
                            </div>
                            <div class="form-group">
                                <label class="col-xs-2 control-label "  > 护照状态: </label>
                                <dm:list tabName="t_dm_hzzt" type="select"    name="status"   value="${hz.status}" ></dm:list>
                            </div>
