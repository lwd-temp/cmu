...
<div >
    <form class="form-horizontal" role="form">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 教师姓名: </label>

            <div class="col-sm-3">
                <input type="text" id="form-field-1" placeholder="教师姓名" class="col-xs-12" />
            </div>

            <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 出访国家: </label>

            <div class="col-sm-3">
                <input type="text" id="form-field-2" placeholder="出访国家" class="col-xs-12" />
            </div>
...
<script type="text/javascript">
                ...
                {name:'id',index:'', fixed:true, sortable:false, resize:true,
                    formatter:function(cellvalue, options, rowObject){
                        var zt = rowObject.zt;
                            ...
                            return  "<button class='btn btn-info btn-mini' title='测试' onclick='cgsh(\"+cellvalue+\")' ><i class='ace-icon fa fa-pencil '>审核</i></button>" +
                                "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class='btn btn-danger btn-mini' title='归档' onclick='cggd(\"+cellvalue+\")' ><i class='ace-icon fa fa-check '>归档</i></button>";
    ...
    function cggd(sqid){
        layer.newpage({
            area: ['600px', "300px"],
            title:'归档',
            content:'business/cggl/cggl_sh_gd.jsp',
        });
    }
