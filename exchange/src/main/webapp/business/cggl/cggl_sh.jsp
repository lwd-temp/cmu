        ...
        <div class="tab-content">
            <div id="home" class="tab-pane fade in active">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-10">
                        <dm:list tabName="t_dm_cfmd"  name="cfmd" id="cfmd" value="${cgdqcgj.cfmd}" readonly="readonly"   data-placeholder="请选择出访目的"  onchange="selectcfmd(this)"></dm:list>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-4">
                        <dm:list tabName="t_dm_cgsqlx"  name="cglx" id="cglx" value="${cgdqcgj.cglx}" readonly="readonly"   data-placeholder="请选择申请类别"  onchange="selectcglx(this)"></dm:list>
                    </div>
