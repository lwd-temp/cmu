                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <input type="text"  name="username"  value="姓名" readonly="readonly"    class="col-xs-12" />
                                </div>

                                <label class="col-xs-2 control-label "  > 性别: </label>
                                <div class="col-xs-4">
                                    <input type="text"  name="username"  value="男" readonly="readonly"     class="col-xs-12" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-xs-2 control-label "  > 出生日期 : </label>
                                <div class="col-xs-4">
                                    <input type="text"  name="username"  value="1999-01-01" readonly="readonly"    class="col-xs-12" />
                                </div>

                                <label class="col-xs-2 control-label "  > 出生地: </label>
                                <div class="col-xs-4">
                                    <input type="text"  name="username"  value="北京" readonly="readonly"     class="col-xs-12" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <input type="text"  name="username"  value="户籍所在地" readonly="readonly"     class="col-xs-12" />
                                </div>

                                <label class="col-xs-2 control-label "  > 身份证号: </label>
                                <div class="col-xs-4">
                                    <input type="text"  name="username"  value="101010190101015489" readonly="readonly"     class="col-xs-12" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-xs-2 control-label "  > 所属二级单位   : </label>
                                <div class="col-xs-4">
                                    <input type="text"  name="username"  value="所属二级单位" readonly="readonly"     class="col-xs-12" />
                                </div>

                                <label class="col-xs-2 control-label "  > 科室: </label>
                                <div class="col-xs-4">
                                    <input type="text"  name="username"  value="科室" readonly="readonly"     class="col-xs-12" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-xs-2 control-label "  > 职务   : </label>
                                <div class="col-xs-4">
                                    <input type="text"  name="username"  value="职务" readonly="readonly"     class="col-xs-12" />
                                </div>

                                <label class="col-xs-2 control-label "  > 职称: </label>
                                <div class="col-xs-4">
                                    <input type="text"  name="username"  value="职称" readonly="readonly"     class="col-xs-12" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <select class="chosen-select form-control"   data-placeholder="请选择出访团组">
                                        <option value="">  </option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <select class="chosen-select form-control"   data-placeholder="请选择出访目的" onchange="if($(this).val() == '99'){$('#cfmd_qt').show()}else{$('#cfmd_qt').hide()}">
                            ...
                            <div class="form-group" id="cfmd_qt"  style="display: none;">
                                ...
                                <div class="col-xs-10">
                                    <input type="text"  name="username"  value=""     placeholder="demo@cmu.edu.cn"    class="col-xs-10" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <select class="chosen-select form-control"   data-placeholder="请选择申请类别"  >
                                        <option value="">  访问考察</option>
