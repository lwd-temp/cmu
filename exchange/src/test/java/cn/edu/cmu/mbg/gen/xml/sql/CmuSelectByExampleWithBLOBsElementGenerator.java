 ...
 * 
 */
public class CmuSelectByExampleWithBLOBsElementGenerator extends SelectByExampleWithBLOBsElementGenerator {

    private static String VALID = "VALID";

    public CmuSelectByExampleWithBLOBsElementGenerator() {
        super();
    }
