...
public class HyRymdServiceImplTest extends SpringIOC {
    ...
    public void save() throws Exception {
        HyRymd hyRymd = new HyRymd(CmuStringUtil.UUID(), "01", "01", "01", "01","01", "01", "01", "01", "3e0b62966c6347d49729316edfa79fda", null,null);
    ...
    public void deleteById() throws Exception{
        ...
        HyRymd hyRymd = new HyRymd(keyId, "01", "01", "01", "01","01", "01", "01", "01", "3e0b62966c6347d49729316edfa79fda", null,null);
        boolean success = service.insert(hyRymd);
